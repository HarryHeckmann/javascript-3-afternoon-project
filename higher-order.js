...
//Code Here
let totalPopulation = populations.reduce((a,b) => a + b) //  = populations.reduce(/* Provide Your Callback Here */)
...
//Code Here
let myStrongest = monstersInYourPocket.filter((cp,i,arr) => arr[i]['CP'] > 200) 
...
let bobsTotal = purchases.reduce((a,b,i,arr) => arr[a] + arr[b]) // NEEDS WORK
